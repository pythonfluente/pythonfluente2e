...
O sujeito de um padrão de classe pode ser uma instância de qualquer classe, não apenas instâncias de classes de dados.footnote:[Trato desse conteúdo aqui por ser o primeiro capítulo sobre classes definidas pelo usuário, e acho que _pattern matching_ com classes é um assunto muito importante para esperar até a <<vl_func_obj>> do livro.
