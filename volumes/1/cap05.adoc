...
Veremos mais sobre isso em
fpy.li/2p?typeddict_sec[TypedDict] (vol. 3, cap. 15).
====
...
Voltaremos a este tema em
fpy.li/2p?problems_annot_runtime_sec[Problemas com anotações durante a execução] (vol. 3, cap. 15).
====
...
Leia mais em
fpy.li/2p?legacy_deprecated_typing_box[Suporte a tipos de coleção descontinuados] (vol. 2, cap. 8).
====
...
Na
fpy.li/2p?positional_pattern_implement_sec[Suportando o pattern matching posicional] (vol. 3, cap. 11)
vamos escrever código para definir `+__match_args__+` em uma classe que criaremos sem a ajuda de uma fábrica de classes.
