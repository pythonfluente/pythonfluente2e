...
E há um exemplo mais longo na
fpy.li/2p?pattern_matching_case_study_sec[Pattern matching no lis.py: um estudo de caso] (vol. 4, cap. 18).
====
...
Nosso foco aqui é a desestruturação de sequências, então não vou explicar as ações do avaliador. Veja a 
fpy.li/2p?pattern_matching_case_study_sec[Pattern matching no lis.py: um estudo de caso] (vol. 4, cap. 18)
...
Em
fpy.li/2p?how_slicing_works[Como funciona o fatiamento] (vol. 3, cap. 12), 
...
fpy.li/2p?sliceable_sequence[Vector versão #2: Uma sequência fatiável] (vol. 3, cap. 12).
