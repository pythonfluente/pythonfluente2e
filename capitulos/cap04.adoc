...
`utf-8`:: De longe a codificação de 8 bits mais comum na web.
Em julho de 2021, o
...
os formatos UTF podem preceder o conteúdo textual por um marcador de ordem dos bytes.
...
A `pyuca` não leva o locale em consideração.
