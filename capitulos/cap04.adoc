...
descrevendo um utilitário para busca no banco de dados Unicode—uma forma ótima de encontrar gatinhos sorridentes ou dígitos rodeados por um círculo, na linha de comando.

Uma pequena mudança que vale a pena mencionar é o suporte a Unicode no Windows,
