...
[quote]
____
* Executar algo em segundo plano. Por exemplo, para encerrar uma requisição web o mais rápido possível, e então atualizar a página do usuário de forma incremental. Isso dá ao usuário a impressão de uma bom desempenho e de "vivacidade", ainda que o trabalho real possa na verdade demorar um pouco mais [para ser concluído].
