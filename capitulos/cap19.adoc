...
Por isso o YouTube, o DropBox, o Instagram, o Reddit e outros foram capazes de obter escalabilidade quando começaram, usando Python como sua linguagem primária—apesar de alegações persistentes dizendo que "O Python não escala." 
...
. O ponteiro animado é mostrado, de forma similar a isso: `<Task pending name='Task-2' coro=<spin() running at /path/to/spinner_async.py:12>>`.
