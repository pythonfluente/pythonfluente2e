...
que frequentemente precisamos ler de APIs JSON ou bancos de dados com schemas semi-estruturados,
...
Após vermos os conjuntos (_sets_), teremos mais a dizer sobre `dict_keys` e `dict_items`,
