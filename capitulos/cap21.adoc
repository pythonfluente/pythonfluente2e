...
A única construção sintática definida na PEP 530 que pode aparecer fora do corpo
...
isto é, elas passam mais tempo esperando por E/S que realizando na memória.
...
Mesmo sistemas triviaiis revelam isso, sob stress.
No <<async_soapbox>>, conto a história de dois programas assíncronos sofrendo com
funções limitadas pela CPU que freiam o loop de eventos,
