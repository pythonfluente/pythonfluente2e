...
Por exemplo, para indexar o caractere U+0037—DIGIT SEVEN—o inicializador
de `InvertedIndex` anexa o caractere `'7'` aos registros sob as chaves `'DIGIT'` e `'SEVEN'`.
Após indexar os dados do Unicode 13.0.0 incluídos no Python 3.9.1, `'DIGIT'` será mapeado para
