...
==== Tipos Mutáveis como Parâmetros Default: Péssima Ideia
...
Tentamos ser espertos, e em vez do valor default `passengers=None`,
temos `passengers=[]`, para evitar o `if` do `+__init__+` anterior. Essa "esperteza" nos traz problemas.
