...
Também((("with, match, and else blocks", "significant changes to"))) atualizei a <<context_utilities_sec>> para incluir alguns recursos do módulo `contextlib` adicionados desde o Python 3.6,
