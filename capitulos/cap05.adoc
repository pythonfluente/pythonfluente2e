...
They are okay as a starting point, but to participate as a grownup object, they need to take some responsibility.footnote:[From _Refactoring, First Edition_, chapter 3, _Bad Smells in Code_, _Data Class_ section, page 87.]
// ____

++++
<blockquote>
<p>Classes de dados são como crianças.
