...
[NOTE]
====
Como observado na <<whats_new_descriptor_sec>>, vários exemplos deste capítulo se tornaram muito mais simples graças ao método especial `+__set_name__+` do protocolo descritor, adicionado no Python 3.6. Isso é evolução da linguagem!
====
