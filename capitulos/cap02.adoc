...
O desempacotamento((("sequences", "unpacking sequences and iterables", id="Sunpack02")))((("iterables", "unpacking", id="iterun02")))((("unpacking", "sequences and iterables")))
...
Definir((("unpacking", "using &#x002A; to grab excess items")))((("star (&#x002A;) operator", id="star02")))((("&#x002A; (star) operator", id="star02a")))
parâmetros de função com `*args` para capturar argumentos arbitrários em excesso é um recurso clássico de Python.
...
ele funciona com estruturas aninhadas.((("", startref="star02")))((("", startref="star02a")))
...
https://docs.python.org/pt-br/3.10/whatsnew/3.10.html#pep-634-structural-pattern-matching["Casamento de padrão estrutural"], de Carol Willing, no
