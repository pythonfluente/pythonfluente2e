...
Muitos dos exemplos no <<data_model>> funcionam por causa do tratamento especial que Python dá a qualquer estrutura vagamente semelhante a uma sequência.
...
como vimos em <<data_model>> e na  <<python_digs_seq_sec>>.
A documentação de
