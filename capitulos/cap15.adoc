...
listadas na <<builders_compared_tbl>> do <<ch_dataclass>>.
...
Se você estiver interessado na história de Python, pode gostar de saber que Guido van Rossum publicou https://fpy.li/15-40["Adding Optional Static Typing to Python" (_Acrescentando Tipagem Estática Opcional ao Python_)] em 23 de dezembro de 2004.
