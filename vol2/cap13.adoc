...
* A <<two_kinds_protocols_sec>> compara
protocolos dinâmicos e estáticos.

* Atualizei a <<defensive_duck_prog_sec>> e dei um título que destaca sua
...
`Vector2d`, que desenvolvemos no <<ch_pythonic_obj>>? Dado que um número
