...
termo _método mágico_ é gíria para "métodos especial.
Para falar de um método específico, por exemplo `+__getitem__+`,
pythonistas comoo autor Steve Holden dizem "dunder-getitem".
