...
Esse exemplo, copiado de «O que há de novo no Python 3.8» [.small]#&#91;fpy.li/48&#93;#, mostra como emular a função embutida `divmod`:
...
Se você passar os nomes de vários atributos para `attrgetter`, ela devolve um tupla de valores.
...
que facilitam a programação funcional, reduzindo a necessidade de lidar com a sintaxe limitado do `lambda` em Python.
...
Em _A Referência da Linguagem Python_, a seção «3.2. A hierarquia de tipos padrão» [.small]#&#91;fpy.li/47&#93;# mostra os noves tipos invocáveis, juntamente com todos os outros tipos embutidos.
...
Refletindo sobre a pergunta "Seria Python uma linguagem funcional?", criei uma de minhas palestras favoritas, _Beyond Paradigms_ ("Além dos Paradigmas"), que apresentei na PyCaribbean, na PyBay e na PyConDE.
