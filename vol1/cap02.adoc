...
A criação de novos tipos de sequência é o tema do Capítulo 12 [.small]#&#91;vol.2, fpy.li/4t&#93;#.
...
agora é um «artigo» [.small]#&#91;fpy.li/bisect&#93;# (EN)
...
A «PEP 572—Assignment Expressions» [.small]#&#91;fpy.li/pep572&#93;# (EN) define o escopo do alvo de um `:=`
...
«repositório de código de Python Fluente» [.small]#&#91;fpy.li/code&#93;#
...
«PEP 3132 -- Extended Iterable Unpacking (_Desempacotamento Estendido de Iteráveis_)» [.small]#&#91;fpy.li/2-2&#93;#.
...
A «PEP 448—Additional Unpacking Generalizations (_Generalizações adicionais de desempacotamento_)» [.small]#&#91;fpy.li/pep448&#93;#
...
«"O que há de novo no Python 3.5" » [.small]#&#91;fpy.li/2q&#93;# (EN).
...
«PEP 634—Structural Pattern Matching: Specification (_Casamento Estrutural de Padrões: Especificação_)» [.small]#&#91;fpy.li/pep634&#93;# (EN).
...
«"A very deep iterable and type match with extraction" (_Um match de iterável e tipo muito profundo, com extração_)» [.small]#&#91;fpy.li/2-10&#93;# (EN).
====
...
«"(How to Write a (Lisp) Interpreter (in Python))" _(Como Escrever um Interpretador (Lisp) em (Python))_» [.small]#&#91;fpy.li/2-12&#93;#.
====
...
e da criação de novas classes na Parte III—Classes e protocolos [.small]#&#91;vol.2, fpy.li/4v&#93;#.
...
Voltaremos aos objetos +slice+ quando formos discutir a criação de suas próprias coleções, na Seção 12.5 [.small]#&#91;vol.2, fpy.li/4x&#93;#.
...
Veja  «NumPy quickstart» [.small]#&#91;fpy.li/2-13&#93;# (EN)
...
Os métodos especiais `++__iadd__++` e `++__imul__++` são tratados no Capítulo 16 [.small]#&#91;vol.2, fpy.li/4r&#93;#.
...
O «Online Python Tutor» [.small]#&#91;fpy.li/2-14&#93;# (EN) é uma ferramenta online fantástica
...
Veja o artigo «Fluent interface» [.small]#&#91;fpy.li/2-15&#93;# (EN)
...
Ela aceita qualquer objeto iterável como um argumento, incluindo sequências imutáveis e geradores (veja o Capítulo 17 [.small]#&#91;vol.3, fpy.li/4s&#93;#).
...
Há uma introdução ilustrada ao módulo `bisect` no post «"Managing Ordered Sequences with Bisect" (_Gerenciando Sequências Ordenadas com Bisect_)» [.small]#&#91;fpy.li/bisect&#93;# (EN)
...
Para manter a ordem de um array ordenado ao acrescentar novos itens, use a função «`bisect.insort`» [.small]#&#91;fpy.li/2t&#93;#.
====
...
responde assim à questão «"When should a memoryview be used?" _Quando se deve usar uma memoryview?_» [.small]#&#91;fpy.li/2-17&#93;#:
...
«"Parsing binary records with struct" _Analisando registros binários com struct_» [.small]#&#91;fpy.li/2-18&#93;# (EN).
====
...
como a «Pandas» [.small]#&#91;fpy.li/2-20&#93;# (EN)—que implementa tipos eficientes de arrays capazes de conter dados não-numéricos,
e fornece funções de importação/exportação em vários formatos diferentes, como _.csv_, _.xls_, dumps SQL, HDF5,
etc.—e a «scikit-learn» [.small]#&#91;fpy.li/2-21&#93;# (EN), o conjunto de ferramentas para Aprendizagem de Máquina mais usado atualmente.
...
«PEP 448—Additional Unpacking Generalizations (_Generalizações de Desempacotamento Adicionais_)» [.small]#&#91;fpy.li/pep448&#93;#
(EN).
...
do «Python Cookbook, 3rd ed.» [.small]#&#91;fpy.li/pycook3&#93;#
...
A «PEP 3132--Extended Iterable Unpacking (_Desempacotamento Estendido de Iterável_)» [.small]#&#91;fpy.li/2-2&#93;#
...
«"Missing *-unpacking generalizations" (_As generalizações esquecidas de * no desempacotamento_)» [.small]#&#91;fpy.li/2-24&#93;#
...
«PEP 636—Structural Pattern Matching: Tutorial (_Casamento de Padrões Estrutural: Tutorial_)» [.small]#&#91;fpy.li/pep636&#93;#
(EN) também é bom, porém mais longo.
A mesma PEP 636 inclui o
«"Appendix A—Quick Intro" (_Apêndice A-Introdução Rápida_)» [.small]#&#91;fpy.li/2-27&#93;# (EN).
...
«PEP 635—Structural Pattern Matching: Motivation and Rationale (_Casamento de Padrões Estrutural: Motivação e Justificativa_)» [.small]#&#91;fpy.li/pep635&#93;#
(EN).

O post de Eli Bendersky em seu blog,
«"Less copies in Python with the buffer protocol and memoryviews" (_Menos cópias em Python, com o protocolo de buffer e mamoryviews_)» [.small]#&#91;fpy.li/2-28&#93;#
...
«Python for Data Analysis» [.small]#&#91;fpy.li/2-30&#93;#, de Wes McKinney.

"A Numpy é toda sobre vetorização". Essa é a frase de abertura do livro de acesso aberto
«From Python to NumPy» [.small]#&#91;fpy.li/2-31&#93;#, de Nicolas P. Rougier.
...
«"Why Numbering Should Start at Zero" (_Porque a Numeração Deve Começar em Zero_)» [.small]#&#91;fpy.li/2-32&#93;#.
...
A letra de Dijkstra é tão cristalina que alguém criou uma «fonte» [.small]#&#91;fpy.li/2-33&#93;# a partir de suas anotações.
...
Por exemplo, veja essa «ordem do Juiz William Alsup» [.small]#&#91;fpy.li/2-36&#93;# (EN) de 2012.
...
Você pode ler mais sobre essa teoria da conspiração em «Python Humor» [.small]#&#91;fpy.li/2-37&#93;# (EN).
