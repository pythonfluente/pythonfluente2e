...
«Casamento de padrão estrutural» [.small]#&#91;fpy.li/2r&#93;#footnote:[NT:
...
<2> Este padrão casa se o sujeito é uma sequência de três itens,
...
Com casamento de padrões, podemos acrescentar verificações e ainda manter o programa legível.
...
lembre-se de que seu valor só será fixo se todos os seus itens também forem imutáveis.
