...
|       `+s.__rmul__(n)+` |   ●   |   ●   | `+n * s+`—concatenação repetida inversafootnote:[Operadores invertidos são explicados no Capítulo 16 [.small]#&#91;vol.2, fpy.li/4r&#93;.&#93;#
...
|         `s.remove(e)` |   ●   |       | Remove o primeiro elemento de valor igual a `e`
|         `s.reverse()` |   ●   |   ●   | Reverte a ordem dos itens internamente
