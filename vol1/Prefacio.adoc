...
Um dos pacotes padrão de testagem de Python, o «_doctest_» [.small]#&#91;fpy.li/doctest&#93;#, funciona simulando sessões de console e verificando se as expressões resultam nas resposta exibidas. Usei `doctest` para verificar a maior parte do código desse livro, incluindo as listagens do console.
...
para não violar os direitos da editora que publicou a aquela primeira edição de 2015.
