...
Isso é verdade, mas há uma pegadinha: como a linguagem é fácil de entender e começar a usar, muitos programadores praticantes de Python se contentam apenas com uma fração de seus poderosos recursos.
...
você poderá achar difícil acompanhar este livro.
...
Também é mais provável herdarmos de ABCs existentes que criar uma nova ABC do zero.
