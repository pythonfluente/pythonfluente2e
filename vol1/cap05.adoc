...
Veremos mais sobre isso na Seção 15.3 [vol.2, fpy.li/29].
====
...
Voltaremos a isso bem mais tarde neste livro, na Seção 15.5.1 [vol.2, fpy.li/2a].
====
...
e de anotações mais avançadas no Capítulo 15 [vol.2, fpy.li/54].
...
(_descriptors_)—um recurso avançado tratado no Capítulo 23 [vol.3, fpy.li/55].
...
[NOTE]
====
No Capítulo 14 [vol.2, fpy.li/56] vamos falar sobre o uso indevido da herança,
...
Na Seção 11.8 [vol.2, fpy.li/2c] vamos escrever código para definir
