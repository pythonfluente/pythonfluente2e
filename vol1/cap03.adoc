...
«"Internals of sets and dicts" (_As entranhas dos sets e dos dicts_)» [.small]#&#91;fpy.li/hashint&#93;# (EN)
para o http://fluentpython.com, o site que complementa o livro.
O «post de 18 páginas» [.small]#&#91;fpy.li/hashint&#93;# (EN) foi atualizado e expandido, e inclui explicações e diagramas sobre:
...
[options="header", cols="7,^2,^3,^3,15"]
|===========================================================================================================================================================================================================================================================================
...
|          `+d.__ror__(other)+` |  ●   |      ●      |      ●      | Suporte a `other \| dd`—operador de união invertido (Python ≥ 3.9)footnote:[Operadores invertidos são tratados no Capítulo 16 [.small]#&#91;vol.2, fpy.li/4r&#93;.&#93;#
...
sem maiores problemas. footnote:[NT: O problema exato de se criar subclasses de `dict` e de outros tipos embutidos
...
que é um `dict` vinculado a cada instância.footnote:[NT: A menos que classe tenha um atributo `+__slots__+`,
...
A ordem da saída muda a cada processo Python, devido ao _salting hash_ footnote:[NT: *Salting hash* é a técnica de adicionar um valor aleatório ao cálculo do hash para torná-lo imprevisível e mais seguro contra ataques de colisão.], mencionado na <<what_is_hashable>>.
...
[options="header",cols="10,^5,^5,^5,15"]
|========================================================================================================================
