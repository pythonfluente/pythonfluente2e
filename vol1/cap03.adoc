...
dependendo das regras de sobrecarga de operadores, que exploraremos no Capítulo 16 [vol.2, fpy.li/4r].
...
Vamos discutir isso em detalhes no Capítulo 13 [vol.2, fpy.li/4q].
====
...
A Seção 18.3.4 [vol.3, fpy.li/4y] explica uma subclasse de `ChainMap` usada para implementar
