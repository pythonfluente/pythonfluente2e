...
«"Parsing binary records with struct" (_Analisando registros binários com struct_)» [.small]#&#91;fpy.li/4-3&#93;#, 
no
...
«"Building Multi-character Emojis" (_Criando emojis multi-caractere_)» [.small]#&#91;fpy.li/4-4&#93;# ,
...
«PEP 461–Adding % formatting to bytes and bytearray (_Acrescentando formatação com % a bytes e bytearray_)» [.small]#&#91;fpy.li/pep461&#93;#. ]
...
«W³ Techs: Usage statistics of character encodings for websites» [.small]#&#91;fpy.li/4-5&#93;#
...
«Chardet–The Universal Character Encoding Detector (_Chardet—O Detector Universal de Codificações de Caracteres_)» [.small]#&#91;fpy.li/4-8&#93;#
...
foi na excelente apresentação de Ned Batchelder, «"Pragmatic Unicode" (_Unicode pragmático_) » [.small]#&#91;fpy.li/4-10&#93;# na US PyCon 2012.]
...
«PEP 528–Change Windows console encoding to UTF-8 (_Mudar a codificação do console no Windows para UTF-8_)» [.small]#&#91;fpy.li/pep528&#93;#
...
Outra mudança foi a «PEP 529–Change Windows filesystem encoding to UTF-8 (_Mudar a codificação do sistema de arquivos do Windows para UTF-8_)» [.small]#&#91;fpy.li/pep529&#93;#,
...
* `'㊷'` `CIRCLED NUMBER FORTY TWO`—não existe nem no CP 1252 nem no CP 437 (nem na fonte padrão que usei para gerar esta edição do livro).

[WARNING]
====
Este livro foi escrito em UTF-8, portanto em tese eu posso usar qualquer caractere Unicode.
Porém, a fonte padrão do Asciidoc para gerar o PDF não tem todos os caracteres Unicode.
Não consegui achar o caractere `CIRCLED NUMBER FORTY TWO` em outra fonte,
então no livro impresso ele aparece como tofu.
Mas no livro em HTML, está tudo certo.
Veja o número 42 dentro de um círculo neste mesmo exemplo, no «PythonFluente.com»
[.small]#&#91;fpy.li/5t&#93;#.
====
...
«Default Unicode Collation Element Table (_Tabela Default de Ordenação de Elementos Unicode_)» [.small]#&#91;fpy.li/4-19&#93;# do _Unicode.org_.
...
Dê uma olhada na «PyICU» [.small]#&#91;fpy.li/4-20&#93;#,
...
«General Category» [.small]#&#91;fpy.li/4-22&#93;#  no artigo «Unicode character property» [.small]#&#91;fpy.li/4-23&#93;#
...
image::../images/flpy_0405.png[align="left",pdfwidth=10cm]
...
image::../images/flpy_0406.png[align="left",pdfwidth=10cm]
...
«Unconfusing Unicode: What Is Unicode? (Desconfundindo o Unicode: o que é o Unicode?)» [.small]#&#91;fpy.li/4-31&#93;#.
O Unicode é um padrão complexo, então o UMMU de Lennart é um ponto de partida muito útil.

O «Unicode HOWTO» [.small]#&#91;fpy.li/3k&#93;#
...
«Python Cookbook, 3rd ed.» [.small]#&#91;fpy.li/pycook3&#93;# (O'Reilly),
...
_Recipe 6.11. Reading and Writing Binary Arrays of Structures"
(_Receita 6.11. Lendo e Escrevendo Arrays de Registros Binários_).
...
é mais fácil de ler, bem como o «NFC FAQ» [.small]#&#91;fpy.li/4-50&#93;# de
...
Para((("Soapbox sidebars", "plain text"))) qualquer um que lide diariamente com texto em línguas diferentes do inglês
 "texto puro" não significa "ASCII". O «Glossário do Unicode» [.small]#&#91;fpy.li/4-55&#93;#
  define((("plain text"))) _texto puro_ dessa forma:
...
Estou escrevendo este livro em um formato de texto puro chamado, ironicamente, «AsciiDoc» [.small]#&#91;fpy.li/4-56&#93;#,
que é parte do conjunto de ferramentas da plataforma de publicação de livros
«Atlas» [.small]#&#91;fpy.li/4-57&#93;#
da O'Reilly.
...
Usamos o «AsciiDoctor» [.small]#&#91;fpy.li/4p&#93;#, escrito em Ruby, porque o AsciiDoc original em Python está abandonado.
