...
(_Codificação de Caracteres e Unicode no Python_) na PyCon 2014 («slides» [.small]#&#91;fpy.li/4-1&#93;# (EN), «vídeo» [.small]#&#91;fpy.li/4-2&#93;# (EN)).]
____
...
«"Parsing binary records with struct" (_Analisando registros binários com struct_)» [.small]#&#91;fpy.li/4-3&#93;#, (EN)
no
...
«"Building Multi-character Emojis" (_Criando emojis multi-caractere_)» [.small]#&#91;fpy.li/4-4&#93;# (EN),
...
Veja «documentação de  `codecs.register_error`» [.small]#&#91;fpy.li/39&#93;# (EN).
====
...
Confira «esta página lá no PythonFluente.com» [.small]#&#91;fpy.li/5r&#93;#.
====
...
«documentação sobre codecs» [.small]#&#91;fpy.li/3a&#93;# (EN)
de Python:
...
foi na excelente apresentação de Ned Batchelder, «"Pragmatic Unicode" (_Unicode pragmático_) (EN)» [.small]#&#91;fpy.li/4-10&#93;# na US PyCon 2012.]
...
«General Category» [.small]#&#91;fpy.li/4-22&#93;# (EN) no artigo «Unicode character property» [.small]#&#91;fpy.li/4-23&#93;#
...
(_Codificação de caracteres e o Unicode no Python_)
(«slides» [.small]#&#91;fpy.li/4-1&#93;#, «vídeo» [.small]#&#91;fpy.li/4-2&#93;#) (EN)
...
«"Unconfusing Unicode: What Is Unicode?" (_Desconfundindo o Unicode: O Que É O Unicode?_)» [.small]#&#91;fpy.li/4-31&#93;# (EN).
...
O «Chapter 4, "Strings" (_Capítulo 4, "Strings"_)» [.small]#&#91;fpy.li/4-33&#93;#,
do excelente livro «__Dive into Python 3__» [.small]#&#91;fpy.li/4-34&#93;# (EN)
...
«"Processing Text Files in Python 3" (_Processando Arquivos de Texto em Python 3_)» [.small]#&#91;fpy.li/4-39&#93;# (EN).
Fortemente recomendado.

Uma lista de codificações suportadas pelo Python está disponível em
«Standard Encodings» [.small]#&#91;fpy.li/3m&#93;# (EN),
na documentação do módulo `codecs`.
Se você precisar obter aquela lista de dentro de um programa,
pode ver como isso é feito no script «__/Tools/unicode/listcodecs.py__» [.small]#&#91;fpy.li/4-41&#93;#,
que acompanha o código-fonte do CPython.

Os livros 
«Unicode Explained (Unicode Explicado)» [.small]#&#91;fpy.li/4-42&#93;# (EN),
de Jukka K. Korpela (O'Reilly) e «_Unicode Demystified_ (Unicode Desmistificado)» [.small]#&#91;fpy.li/4-43&#93;#,
...
As páginas do W3C
«"Case Folding: An Introduction" (_Case Folding: Uma Introdução_)» [.small]#&#91;fpy.li/4-45&#93;# (EN) e 
...
A seção
«"Frequently Asked Questions, Normalization" (_Perguntas Frequentes, Normalização_)» [.small]#&#91;fpy.li/4-48&#93;# (EN)
do 
«_Unicode.org_» [.small]#&#91;fpy.li/4-49&#93;#
é mais fácil de ler, bem como o «NFC FAQ» [.small]#&#91;fpy.li/4-50&#93;# (EN) de
...
«o emoji original» [.small]#&#91;fpy.li/4-51&#93;# (EN),
os 176 emojis desenhados por Shigetaka Kurita em 1999 para a NTT DOCOMO—a provedora de telefonia móvel japonesa.
Indo mais longe no passado, a «_Emojipedia_» [.small]#&#91;fpy.li/4-52&#93;# (EN) publicou o artigo
«"Correcting the Record on the First Emoji Set" (_Corrigindo o Registro [Histórico\» [.small]#&#91;fpy.li/4-53&#93;#
...
Estou escrevendo esse livro em um formato de texto puro chamado—ironicamente— «AsciiDoc» [.small]#&#91;fpy.li/4-56&#93;#,
