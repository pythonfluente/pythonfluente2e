...
Nesse caso ele aparece como um retângulo branco apelidado de "tofu"
...
O motivo é que o programa `asciidoctor-pdf` que usei para gerar o livro impresso
...
Para o `VULGAR FRACTION ONE HALF`, a normalização NFKC produz 1 e 2 unidos pelo `FRACTION SLASH`footnote:[Este caractere está aparecendo como tofu no livro impresso, sinto muito. No HTML está OK.],
