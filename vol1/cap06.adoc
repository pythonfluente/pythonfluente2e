...
A <<var-boxes-x-labels>> explica porque a metáfora da caixa está errada em Python,
...
uma “vincular” é uma alternativa melhor:
...
Para ilustrar porquê, no <<ex_haunted_bus>>,
...
Em CPython, um objeto é descartado assim que o número de referências a ele chega a zero.
...
Leia https://fpy.li/weakref["Weak References" em _fluentpython.com_]
