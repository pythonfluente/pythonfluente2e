...
O `is` também é útil para testar valores de classes derivadas de `enum.Enum`.footnote:[Agradeço Ruan Comelli, revisor da tradção brasileira, por ter me lembrado o caso de uso do operador `is` com objetos `Enum`.]
