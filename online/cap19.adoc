...
Se tiver curiosidade, veja o https://fpy.li/19-25[«diff mostra o bug e sua correção»]—mas
saiba que depois eu refatorei o exemplo para delegar partes de `main`
para as funções `start_jobs` e `report`. Escrevi um
