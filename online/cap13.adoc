...
Desde Python 3.8, temos quatro maneiras.
...
Tipagem estática::
    ...
    suportada desde Python 3.5 pelo módulo `typing`,
...
Para reduzir o tempo de carregamento, desde Python 3.4 aquele módulo é implementado fora do pacote `collections` — em https://fpy.li/13-14[_Lib/_collections_abc.py_] — então é importado separado de `collections`.
