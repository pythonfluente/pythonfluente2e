...
https://fpy.li/7-2["Introspection of Function Parameters" (_Introspecção de Parâmetros de Funções_)], no _https://fluentpython.com_.
====
...
No Python 3.10, a https://fpy.li/47[documentação do modelo de dados] lista nove tipos invocáveis:
...
Em _A Referência da Linguagem Python_, a seção https://fpy.li/47["3.2. A hierarquia de tipos padrão"] mostra os nove tipos invocáveis, juntamente com todos os outros tipos embutidos.
