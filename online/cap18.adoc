...
é garantir que um arquivo seja fechado. O <<with_file_demo>> é uma
...
de Martijn Pieters. O <<inplace_ex>> mostra como usar a
...
mas não é amigável para o usuário (veja o <<ex_lispy_repl>>). Se nenhum argumento de
