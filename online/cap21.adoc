...
Veremos também como evitar o bloqueio do laço de eventos, delegando operações lentas para um executor de threads ou processos.
...
Na documentação oficial, não deixe de ler https://fpy.li/ba["Desenvolvendo com asyncio"], que documenta o modo de depuração do _asyncio_ e também discute erros e armadilhas comuns, e como evitá-los.
