...
O início de _tcp_mojifinder.py_—incluindo as instruções `import`—está no <<tcp_mojifinder_top>>,mas vou começar descrevendo a corrotina `supervisor` e a função `main` que controla o programa.
...
oficial], após a fantástica https://fpy.li/21-69[reorganização] (EN) iniciada
