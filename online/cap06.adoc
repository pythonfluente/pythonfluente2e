...
https://fpy.li/weakref[um post em _https://fluentpython.com_].
====
...
Python -- lists, dicts, sets, etc..&#x2014; são contêineres:
...
<3> A inspeção do atributo `passengers` mostra que
...
https://fpy.li/weakref["Weak References" em _https://fluentpython.com_].
====
...
Leia https://fpy.li/weakref["Weak References" em _https://fluentpython.com_]
