...
Além de `@dataclass`, um exemplo interessante—e mais simples—de decorador de classes na biblioteca padrão de Python é https://fpy.li/7q[`functools.total_ordering`] (EN), que gera métodos especiais para comparação de objetos.
