...
Graças a `+__class_getitem__+`, os desenvolvedores principais de Python não precisaram escrever uma nova metaclasse para que os tipos embutidos implementassem `+__getitem__+`, de modo que fosse possível escrever dicas de tipo genéricas, tal como `list[int]`.
...
Em setembro de 2020, Marc Shannon, um dos desenvolvedores principais de Python, publicou a
...
Claramente não é uma prioridade muito alta entre os desenvolvedores principais de Python.
