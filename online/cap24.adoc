...
Toda classe tem alguns atributos definidos no Modelo de Dados de Python, documentados na seção https://docs.python.org/pt-br/3/library/stdtypes.html#special-attributes["4.13. Atributos Especiais"] do capítulo "Tipos Embutidos" da _Biblioteca Padrão de Python_.
...
https://docs.python.org/pt-br/3/reference/datamodel.html["Modelo de Dados"] da referência de Python.
...
Além de `@dataclass`, um exemplo interessante—e mais simples—de decorador de classes na bilbioteca padrão de Python é https://docs.python.org/pt-br/3/library/functools.html#functools.total_ordering[`functools.total_ordering`] (EN), que gera métodos especiais para comparação de objetos.
