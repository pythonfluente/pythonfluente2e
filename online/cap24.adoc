...
Entretanto, alguns dos exemplos antigos não representam mais as soluções mais simples, tendo em vista os novos recursos surgidos desde Python 3.6.
...
----
====
<1> Lembre-se, desde Python 3.9, o tipo `Callable` para anotações é a ABC em
