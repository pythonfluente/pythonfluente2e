...
pass:[<code>ThreadPool&#x200b;Executor</code>] decide seu valor usando, desde Python 3.8, a seguinte expressão:
...
Desde Python 3.4, há duas classes chamadas `Future` na biblioteca padrão:
