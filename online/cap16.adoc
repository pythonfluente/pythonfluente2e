...
diferentes camadas da rede. Veja https://fpy.li/16-15["Stacking layers"
(_Empilhando camadas)] para mais detalhes.
...
(Uma técnica simples para tratar polimorfismo múltiplo_)], de Dan Ingalls
...
Gosling_), de onde tirei a epígrafe deste capítulo, apareceu na _Java Report_, 5(7),
...
O <<ch_generators>> vai tratar das expressões geradoras em detalhes, mas eu não
