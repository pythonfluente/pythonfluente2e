...
https://fpy.li/2z[`Py_TPFLAGS_MAPPING`] (EN).]
...
que é um `dict` vinculado a cada instância.footnote:[A menos que classe tenha um atributo `+__slots__+`,
...
no pass:[<a href="http://fluentpython.com" class="orm:hideurl"><em>fluentpython.com</em></a>] para mais detalhes.
...
inspirada por um exemplo do capítulo 6 do excelente https://fpy.li/38[_The Go Programming Language_ (A Linguagem de Programação Go)] (EN),
