...
apesar do índice de pacotes do Python hoje listar mais de 490.000 bibliotecas, e de muitas delas serem inacreditavelmente úteis.footnote:[Eram 60.000 pacotes quando revisei este parágrafo da última vez!]
