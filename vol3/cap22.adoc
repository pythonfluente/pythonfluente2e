...
No <<ex_vector2d_v3>> do https://fpy.li/11[«Capítulo 11»] (vol.2),
...
Vimos `@cache` e `@lru_cache` na <<memoization_sec>> (https://fpy.li/9[«Capítulo 9»] (vol.2)). Python 3.8 introduziu `@cached_property`.
